...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 w-screen h-[80px] z-50 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>LaunchSUV.Ke</h1>
          <ul className='hidden md:flex'>
          <li><Link to="home" smooth={true} duration={500}>Home</Link></li>
          <li><Link to="about" smooth={true} offset={-200} duration={500}>About</Link></li>
          <li><Link to="testimony" smooth={true} offset={-100} duration={500}>Testimonials</Link></li>
          <li><Link to="features" smooth={true} offset={-200} duration={500}>Features</Link></li>
          <li><Link to="pricing" smooth={true} offset={-50} duration={500}>Pricing</Link></li>
          </ul>
        </div>
        <div className='hidden md:flex pr-4'>
            <Link className='bg-gradient-to-r from-orange-500 to-orange-800 px-8 py-3' to='pricing' smooth={true} offset={-50} duration={500}>
            Get Access
            </Link>
        </div>
