/*
  Author: jesse onyango nehemiah
  Description: Mpesa Daraja API with Node JS backend for the landing page
  ...
  getAccessToken()
    .then((accessToken) => {
      ...
      axios
        ...
        .then((response) => {
          // res.send(" Request is successful done enter mpesa pin to complete the transaction");
