...
const AuthPage = () => {
  ...
  const toggleForm = () => {
    setIsLogin(!isLogin); // Toggle form state
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(res.data); // Handle the response as needed (e.g., store JWT)
    } catch (err) {
      console.error(err.response.data); // Handle the error as needed (e.g., show error message)
    }
  };
